...
Retrouvez ce superbe programmme, ainsi que son équivalent "dirty",
...
def main():
    ...
    # ---- code spécial pas-dirty
    #on va foutre tous les sprites à afficher dans ce groupe.
    #Ce groupe est censé gérer des sprites normaux. Et il gère les rectangles
    #de rafraichissage des sprites.
    allsprites = pygame.sprite.RenderUpdates()
    # ---- fin code spécial pas-dirty
    ...
    # ---- code spécial pas-dirty
    #sprite tout à fait normal.
    spriteCarreRouge = pygame.sprite.Sprite()
    # ---- fin code spécial pas-dirty    
    ...
    while 1:
        ...
        # ---- code spécial pas-dirty
        print "mode normal. liste des rect a repeinturer : ", listRectToRepaint
        # ---- fin code spécial pas-dirty
        
        pygame.display.update(listRectToRepaint)
        # ---- spécial pas-dirty : si on réaffiche tout à chaque fois, ça fait pareil ----
