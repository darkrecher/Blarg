...
- [Exploitation du code source](#exploitation-du-code-source)
    - [Table des matières](#table-des-mati%C3%A8res)
    - [Windows](#windows)
        - [Lancement du jeu à partir du code source (win)](#lancement-du-jeu-%C3%A0-partir-du-code-source-win)
            - [Installation de python](#installation-de-python)
            - [Installation de pygame](#installation-de-pygame)
            - [Lancement du jeu](#lancement-du-jeu)
        - [Transformation en exécutable (win)](#transformation-en-ex%C3%A9cutable-win)
            - [Installation de py2exe](#installation-de-py2exe)
            - [Création du .exe](#cr%C3%A9ation-du-exe)
            - [Message d'erreur possible](#message-derreur-possible)
            - [Message d'avertissement](#message-davertissement)
            - [Lancement du jeu avec le .exe](#lancement-du-jeu-avec-le-exe)
            - [Redistribution de l'exécutable](#redistribution-de-lex%C3%A9cutable)
        - [Ajout des icônes (win)](#ajout-des-ic%C3%B4nes-win)
    - [Mac OS X](#mac-os-x)
        - [Lancement du jeu à partir du code source (mac)](#lancement-du-jeu-%C3%A0-partir-du-code-source-mac)
            - [Installation de python et pygame](#installation-de-python-et-pygame)
            - [Démarrage du jeu](#d%C3%A9marrage-du-jeu)
        - [Transformation en exécutable (mac)](#transformation-en-ex%C3%A9cutable-mac)
            - [Installation de py2app et setuptools](#installation-de-py2app-et-setuptools)
            - [Création du .app](#cr%C3%A9ation-du-app)
            - [Création d'un disque .dmg contenant le .app](#cr%C3%A9ation-dun-disque-dmg-contenant-le-app)
            - [Gestion du fichier de sauvegarde](#gestion-du-fichier-de-sauvegarde)
            - [Redistribution de l'application](#redistribution-de-lapplication)
        - [Plantage éventuel à l'exécution](#plantage-%C3%A9ventuel-%C3%A0-lex%C3%A9cution)
        - [Ajout des icônes (mac)](#ajout-des-ic%C3%B4nes-mac)
    - [GNU/Linux, Ubuntu, Fedora, etc.](#gnulinux-ubuntu-fedora-etc)
...
Voir : [logo_icones/ajout_icones.md](logo_icones/ajout_icones.md) .
