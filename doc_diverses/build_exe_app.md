...
- [Exploitation du code source](#exploitation-du-code-source)
    ...
    - [Windows](#windows)
        - [Lancement du jeu à partir du code source](#lancement-du-jeu-%C3%A0-partir-du-code-source)
            - [Installation de python](#installation-de-python)
            - [Installation de pygame](#installation-de-pygame)
            - [Lancement du jeu](#lancement-du-jeu)
        - [Transformation en exécutable](#transformation-en-ex%C3%A9cutable)
        ...
        - [Ajout des icônes](#ajout-des-ic%C3%B4nes)
    - [Mac OS X](#mac-os-x)
        - [Lancement du jeu à partir du code source](#lancement-du-jeu-%C3%A0-partir-du-code-source)
